 ...
 * @author Jose Campos
 */
public class GraficoSensores extends JFrame {
     ...
     */
    public GraficoSensores(String title, File file, int cant) {
        super(title);
        this.file = file;
        this.cant = cant;
    ...
    public GraficoSensores(String title, File file, int cant, int arduino) {
        super(title);
        this.file = file;
        this.cant = cant;
    ...
    public void leerArchivoExcel() {
        try {
            //new File("C:\\Users\\Jose\\Documents\\NetBeansProjects\\Programa\\kkck.xls")
